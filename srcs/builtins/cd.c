...
/*   Updated: 2016/11/22 12:42:31 by vdanain          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		builtin_cd(t_group *grp, t_parse *parse)
{
	...
	if (parse->cmdsplit[1] == NULL)
		path = return_home(grp, NULL);
	else if ((parse->cmdsplit[1][0] != '-' && parse->cmdsplit[2] && parse->cmdsplit[3]) || (parse->cmdsplit[1][0] == '-' && parse->cmdsplit[2] && parse->cmdsplit[3] && parse->cmdsplit[4]))
	{
