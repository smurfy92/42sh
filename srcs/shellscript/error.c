...
/*   Updated: 2016/12/09 04:58:09 by jmontija         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (script->errno == E_INVALID_LOOP)
		ft_putendl_fd("Invalid loop syntax", 2);
	else if (script->errno == E_WRONG_FILE)
